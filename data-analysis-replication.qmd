...
#Creating figure 4a
ggplot(Figure4a, aes(x = Region, y = Microplastic_Count)) +
  geom_boxplot(
    outlier.shape = 10,
    outlier.size = 4) +
  labs(
...
#Comparing to the publication figure 4a
...
#Creating figure 4b
ggplot(Figure4b, aes(x = Region, y = Microplastic_Count)) +
  geom_boxplot(
    fill = "yellow",
    outlier.shape = 10,
    outlier.size = 4) +
...
#Comparing to the publication figure 4b
knitr::include_graphics("images/DataAnalytics_figure4.jpg")
...
#Creating figure 4c
ggplot(Figure4c, aes(x = Region, y = Microplastic_Count, fill = MP_category)) +
  geom_boxplot(
    fill = "#000080",
    outlier.shape = 10,
    outlier.size = 4) +
...
#Comparing to the publication figure 4c
knitr::include_graphics("images/DataAnalytics_figure4.jpg")
...
#Creating figure 7b
ggplot(PYGCMSMS, aes(x = c("PMMA + PP + PVC + PA + PC + N66 + PE + PET + ABS + PUR + RUBBER + PS"), y = ))
...
#Comparing to the publication figure 7
knitr::include_graphics("images/DataAnalytics_figure7.jpg")
```

Output Conclusion:

Boxplot has varying difference in visual appearance but comparable analysis occured
